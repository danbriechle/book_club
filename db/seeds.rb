...
author_1 = book_1.authors.create(name: "Homer")
author_1 = book_2.authors.create(name: "Homer")
author_2 = book_3.authors.create(name: "Aeschylus")
author_2 = book_4.authors.create(name: "Aeschylus")
author_3 = book_6.authors.create(name: "Sophocles")
author_4 = book_7.authors.create(name: "Thucydides")
author_5 = book_8.authors.create(name: "Euripides")
author_5 = book_9.authors.create(name: "Euripides")
author_6 = book_10.authors.create(name: "Herodotus")
author_7 = book_11.authors.create(name: "Aristophanes")
author_8 = book_12.authors.create(name: "Plato")
author_8 = book_13.authors.create(name: "Plato")
